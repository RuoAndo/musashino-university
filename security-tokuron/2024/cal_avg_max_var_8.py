...
# フォントサイズの設定
rcParams.update({
    'font.size': 16,   # 全体のフォントサイズ
    'axes.titlesize': 20,   # 各サブプロットのタイトルサイズ
    'axes.labelsize': 18,   # X軸、Y軸のラベルサイズ
    'xtick.labelsize': 16,  # X軸の目盛りラベルサイズ
    'ytick.labelsize': 16,  # Y軸の目盛りラベルサイズ
...
def process_directory(directory_path, column_index):
    ...
    # Add title
    fig.suptitle('Time Series of Mean, Variance, and Max', fontsize=24)
